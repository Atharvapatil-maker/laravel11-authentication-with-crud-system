                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" value="{{ old('merchant_transaction_id') }}" class="form-control @error('merchant_transaction_id') is-invalid @enderror" name="merchant_transaction_id" id="merchant_transaction_id" placeholder="Merchant Transaction ID">
                                                        <label for="merchant_transaction_id" class="form-label">Merchant Transaction ID</label>
                                                        @error('merchant_transaction_id')
                                                            <p class="invalid-feedback">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" value="{{ old('bank_reference_no') }}" class="form-control @error('bank_reference_no') is-invalid @enderror" name="bank_reference_no" id="bank_reference_no" placeholder="Bank Reference No">
                                                        <label for="bank_reference_no" class="form-label">Bank Reference No</label>
